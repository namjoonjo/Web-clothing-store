...
<nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px" id="mySidebar">
  ...
  <a class="w3-bar-item w3-button w3-padding" style="margin-top:10px;"onclick="location.href='<%=request.getContextPath()%>/movingadminPage'">이달 판매량</a> 
